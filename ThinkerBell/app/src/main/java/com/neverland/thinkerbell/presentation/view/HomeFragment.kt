...
import com.neverland.thinkerbell.presentation.adapter.HomeBannerAdapter
import com.neverland.thinkerbell.presentation.adapter.HomeCategoryVPAdapter
...
class HomeFragment : BaseFragment<FragmentHomeBinding>(R.layout.fragment_home) {
    ...
    override fun initView() {
        val tabLayout: TabLayout = binding.tlHomeCategoryTab
        val viewPager: ViewPager2 = binding.vpHomeNotice
        val categories = resources.getStringArray(R.array.category_list)

        // 각 카테고리에 대한 공지 리스트를 생성합니다.
        val notices = listOf(
            listOf(
        ...
        // 배너 설정
        val bannerImages = listOf(R.drawable.ic_launcher_background, R.drawable.ic_element_delete, R.drawable.ic_alert_warning) // 배너 이미지 리소스 ID 리스트
