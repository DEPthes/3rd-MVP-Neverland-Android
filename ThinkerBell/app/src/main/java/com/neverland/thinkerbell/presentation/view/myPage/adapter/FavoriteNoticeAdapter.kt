...
class FavoriteNoticeAdapter : ListAdapter<CommonNotice, FavoriteNoticeAdapter.NoticeViewHolder>(DiffCallback())
{
    ...
    override fun onBindViewHolder(holder: FavoriteNoticeAdapter.NoticeViewHolder, position: Int) {
